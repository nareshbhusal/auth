...
eval("var handleError = function handleError(err, res) {\n  console.log(err);\n  var statusCode = err.statusCode,\n      message = err.message;\n  statusCode = statusCode || 500;\n  res.status(statusCode).send({\n    status: \"error\",\n    statusCode: statusCode,\n    message: message\n  });\n};\n\nmodule.exports = handleError;\n\n//# sourceURL=webpack:///./src/middlewares/handleError.js?");
...
eval("function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nvar deleteUser = __webpack_require__(/*! ../../controllers/user/deleteUser */ \"./src/controllers/user/deleteUser.js\");\n\nvar _require = __webpack_require__(/*! ../../utils/response */ \"./src/utils/response.js\"),\n    ErrorHandler = _require.ErrorHandler,\n    Success = _require.Success,\n    Fail = _require.Fail; //delete user\n\n\nmodule.exports = /*#__PURE__*/function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res, next) {\n    var user_id;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.prev = 0;\n            user_id = req.session.user_id;\n            _context.next = 4;\n            return deleteUser(user_id);\n\n          case 4:\n            req.session.destroy(function (err) {\n              if (err) {\n                return console.log(err);\n              }\n            });\n            return _context.abrupt(\"return\", Success(200, null, res));\n\n          case 9:\n            _context.prev = 9;\n            _context.t0 = _context[\"catch\"](0);\n            next(_context.t0);\n\n          case 12:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, null, [[0, 9]]);\n  }));\n\n  return function (_x, _x2, _x3) {\n    return _ref.apply(this, arguments);\n  };\n}();\n\n//# sourceURL=webpack:///./src/routes/user/deleteUser.js?");
...
eval("function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nvar getUser = __webpack_require__(/*! ../../controllers/user/getUser */ \"./src/controllers/user/getUser.js\");\n\nvar _require = __webpack_require__(/*! ../../utils/response */ \"./src/utils/response.js\"),\n    ErrorHandler = _require.ErrorHandler,\n    Success = _require.Success,\n    Fail = _require.Fail;\n\nvar NOT_FOUND_ERROR = 'No such user in record'; // get current logged in user\n\nmodule.exports = /*#__PURE__*/function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res, next) {\n    var user_id, userInRecords, fullname, email, joined;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.prev = 0;\n            user_id = req.session.user_id;\n            _context.next = 4;\n            return getUser({\n              user_id: user_id\n            });\n\n          case 4:\n            userInRecords = _context.sent;\n\n            if (userInRecords) {\n              _context.next = 7;\n              break;\n            }\n\n            return _context.abrupt(\"return\", Fail(404, {\n              msg: NOT_FOUND_ERROR\n            }, res));\n\n          case 7:\n            fullname = userInRecords.fullname, email = userInRecords.email, joined = userInRecords.joined;\n            return _context.abrupt(\"return\", Success(200, {\n              fullname: fullname,\n              email: email,\n              joined: joined\n            }, res));\n\n          case 12:\n            _context.prev = 12;\n            _context.t0 = _context[\"catch\"](0);\n            next(_context.t0);\n\n          case 15:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, null, [[0, 12]]);\n  }));\n\n  return function (_x, _x2, _x3) {\n    return _ref.apply(this, arguments);\n  };\n}();\n\n//# sourceURL=webpack:///./src/routes/user/getCurrentUserInfo.js?");
...
eval("var User = __webpack_require__(/*! ../models/User */ \"./src/models/User.js\");\n\nvar sequelize = __webpack_require__(/*! sequelize */ \"sequelize\"); // console.log(sequelize);\n\n\nconsole.log(User.prototype.prototype);\n\n//# sourceURL=webpack:///./src/services/cache.js?");
